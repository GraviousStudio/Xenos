...
export default function GoCatalogue() {
    ...
    return (
        <>
            <div className="flex flex-col md:flex-row p-3 m-3 gap-10 lg:items-center">
                <div className="lg:w-1/2 m-3 p-3">
                ...
                <div className="bg-zinc-900 w-full lg:w-1/2 rounded-3xl transition-all ease-in-out duration-300 hover:shadow-2xl hover:shadow-violet-800">
                    <img src={'https://ichef.bbci.co.uk/ace/standard/976/cpsprodpb/8BB6/production/_103466753_fort.jpg'} alt="" className="w-full h-full rounded-3xl object-center object-cover"/>
                </div>
            </div>
        <br /><hr /><br />
        </>
